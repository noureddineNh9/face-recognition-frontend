...
function App() {
  ...
  const onSubmit = () => {
    ...
    .then(result => {
      ...
      setBoundingBox(result.outputs[0].data.regions[0].region_info.bounding_box)
      document.getElementById('box').classList.remove('hide')
      document.getElementById('face-image-holder').classList.remove('hide')
          ...
          ? <>
            <div className=" text-center">
              <p style={{
                ...
                This Magin Brain will detect faces in your pictures. Git it a try.
              </p>                
